...
named_type_impl<T, Tag, Converter, Skills...>::named_type_impl(const T& value) : value_{value}
{
}

template <typename T, typename Tag, typename Converter, template <typename> class... Skills>
template <typename T_, typename>
named_type_impl<T, Tag, Converter, Skills...>::named_type_impl(T&& value) : value_{std::move(value)}
{
}
...
named_type_impl<T, Tag, Converter, Skills...>::
operator named_type_impl<T, Tag, Converter2, Skills...>() const
{
  return named_type_impl<T, Tag, Converter2, Skills...>(
      Converter2::convert_from(Converter::convert_to(get())));
}
