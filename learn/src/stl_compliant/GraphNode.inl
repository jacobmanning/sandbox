...
template <typename T>
typename GraphNode<T>::adjacency_list_type& GraphNode<T>::get_adjacent_node_indices()
{
  return adjacent_node_indices_;
}

template <typename T>
const typename GraphNode<T>::adjacency_list_type& GraphNode<T>::get_adjacent_node_indices() const
{
  return adjacent_node_indices_;
}
...
{
  return data_ == rhs.data_ && adjacent_node_indices_ == rhs.adjacent_node_indices_;
}
