...
using RequireInputIterator = typename std::enable_if_t<std::is_convertible_v<
...
template <typename BinaryOperandFunction, typename Parameter1Type,
          typename Parameter2Type, typename ReturnType>
using RequireInvocableBinaryOperandFunction = typename std::enable_if_t<
    std::is_invocable_v<BinaryOperandFunction, Parameter1Type,
                        Parameter2Type> &&
    std::is_convertible_v<std::invoke_result_t<BinaryOperandFunction,
                                               Parameter1Type, Parameter2Type>,
                          ReturnType>>;

template <typename InputIt, typename BinaryOperandFunction,
          typename LoopElementType =
              typename std::iterator_traits<InputIt>::value_type,
          typename = RequireInputIterator<InputIt>,
          typename = RequireInvocableBinaryOperandFunction<
              BinaryOperandFunction, int, LoopElementType, void>>
