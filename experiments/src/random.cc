...
int main()
{
  ...
  // Part 3
  const auto my_interests = std::vector<std::string>{"one", "two", "three", "four"};
  const auto your_interests = std::vector<std::string>{"six", "five", "four", "three"};
  const auto common_interests = util::v1::vector_intersection(my_interests, your_interests);
